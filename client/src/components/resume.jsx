...
function Resume() {
  ...
  const resumeData = {
    summary: {
      ...
      contact: [
        { label: "Pune, India", icon: <GoLocation size={20} /> },
        { label: "7040147091", icon: <AiOutlinePhone size={20} /> },
        { label: "kajaldranpise@gmail.com", icon: <AiOutlineMail size={20} /> },
        {
          label: "LinkedIn",
          url: "https://www.linkedin.com/in/kajal-ranpise",
          icon: <FaLinkedin size={20} />,
        },
        {
          label: "GitHub",
          url: "https://github.com/kajal-ranpise",
    ...
    education: [
      {
        ...
        year: "2014 - 2018",
        institute:
          "Ajeenkya DY Patil School of Engineering & Technology, Pune, India",
        /*      description:
          ...
          <div className="row">
            ...
            <div className="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="resume-item pb-0">
                ...
                <p>
                  <em>
                    {resumeData.summary.role} {resumeData.summary.description}
                  </em>
                </p>
